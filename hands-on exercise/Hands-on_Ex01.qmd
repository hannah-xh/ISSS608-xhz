...
![](https://r4va.netlify.app/chap01/img/image1.jpg){width="62"} is an R package for **declaratively** creating **data-driven** graphics based on ***The Grammar of Graphics***
...
::: {style="overflow-x: auto; border: 1px solid #ddd; padding: 10px;"}
