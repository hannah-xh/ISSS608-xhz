...
![](images/clipboard-3675709045.png)

## Quick look of the structure

::: panel-tabset
## Work flow chart

![](images/Untitled%20diagram-2025-02-06-092432.png)

## The code

```{mermaid echo=TRUE,eval=FALSE}
graph TD;
    subgraph "Statistical Analysis Process"
        A["Data Analysis"] --> B["Model Building"]
        B --> C["Model Diagnostics"]
        C --> D{"Issues Found?"}
        D -- Yes --> E["Model Adjustment"]
        E --> C
        D -- No --> F["Result Visualization"]
    end

    subgraph "Tools Used"
        T1["ggstatsplot"]
        T2["R regression methods"]
        T3["performance package"]
        T4["parameters package"]
    end

    subgraph "Detailed Steps"
        S1["Statistical Tests:\n- t-tests\n- ANOVA\n- Bayes factor tests"]
        S2["Model Creation:\n- Regression model\n- Parameter estimation"]
        S3["Assumption Checks:\n- Multicollinearity\n- Normality\n- Homoscedasticity"]
        S4["Visualization:\n- Diagnostic plots\n- Parameter estimates\n- Statistical results"]
    end
...
Table 1: Multiple pairwise comparison tests supported in ggbetweenstats
...
Table 2: Effect sizes and confidence intervals available for each type of test
...
Table 3: Between-subjects tests carried out for each type of analyses
...
### 10.5.2 Importing Excel file: readxl methods
...
### 10.5.3 Multiple Regression Model using lm()
...
### 10.5.4 Model Diagnostic: checking for multicolinearity:
...
### 10.5.5 Model Diagnostic: checking normality assumption
...
### 10.5.6 Model Diagnostic: Check model for homogeneity of variances
...
### 10.5.7 Model Diagnostic: Complete check
...
### 10.5.8 Visualising Regression Parameters: see methods
...
### 10.5.9 Visualising Regression Parameters: *ggcoefstats()* methods
