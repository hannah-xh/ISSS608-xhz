...
![](images/clipboard-1283848075.png)
...
### **11.4.1 Displaying Uncertainty in Point Estimates: Using ggdist Methods**
...
### **11.4.2 Plotting 95% and 99% Confidence Intervals for Point Estimates**
...
p <- ggplot(shared_df) +
  ...
  ggtitle("Confidence Intervals of Maths Scores by Race")
...
### **11.4.3 Visualizing Uncertainty with Gradient Intervals: A ggdist Method**
